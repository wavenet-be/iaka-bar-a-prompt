...
| Champ | Valeur |
|-------|--------|
| **Auteur** | Jean-Noël Collin |
| **Description** | Sublimer des métriques de vente basiques en insights stratégiques pétillants. « Distiller la mission et la vision en un concentré rafraîchissant, clair et stimulant. » |
| **UseCase** | Passer d'un tableau Excel de CA mensuel à une analyse prédictive des opportunités de vente croisée. Se faire aider afin de définir la vision et la mission de l'entreprise en illustrant également avec des cas d'usage concrets par public cible. |
| **Thème** | Rédaction |
| **Sous-thème** | Rédaction assistée + Stratégie |
| **Plateforme** | Copilot (ou généraliste si non critique) |
...
You will find 3 problems / opportunities for each of the categories in the target audience (specified in the #INFORMATION ABOUT ME section)
You will find 3 use-cases for each of the categories in the target audience (specified in the #INFORMATION ABOUT ME section); please use storytelling in order to tell mini-stories
...
1. Begin by understanding the core values and unique selling propositions of the business. What sets it apart from its competitors? What are its strengths and foundational beliefs?
2. Define the target audience and their needs or problems that the business aims to address. How does the business improve their lives or solve their problems?
3. Craft the mission statement: — Start with a powerful verb to indicate action (e.g., empower, revolutionize, simplify). — Clearly state the purpose of the business and how it serves its customers. — Make it specific enough to be meaningful but broad enough to allow for growth and adaptation.
4. Develop the vision statement: — Project a future where the business has achieved its highest aspirations. — Use vivid language to paint a picture of the impact on the world or industry. — Ensure it is aspirational, inspiring stakeholders to strive for this future.
...
- Unique selling propositions: [According to target audience: different plans & pricing (monthly or yearly) but with accessible prices]
...
The 3 problems / opportunities should be clear and reflective related to each target audience
The 3 use-cases should be clear and reflective related to each target audience and written with storytelling technique (telling a mini story)
```