...
| **Description**  | Un cocktail de méthodologie pour créer des prompts professionnels adaptés à chaque besoin |
| **UseCase**      | Analyse de brief et génération de prompts optimisés pour contexte métier |
| **Thème**        | Prompt Engineering                         |
| **Sous-thème**   | Structuration & Optimisation               |
...
2. **Contexte métier** : Quel environnement, quels enjeux ?
3. **Objectif précis** : Que doit produire le prompt ?
4. **Contraintes** : Limites, formats, ton, longueur
5. **Exemples** (si pertinent) : Illustrations concrètes
