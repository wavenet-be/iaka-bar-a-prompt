...
# Le Cuba Libre du Clean Code .NET

## Métadonnées

| Champ | Valeur |
|-------|--------|
| **Auteur** | François Borgies |
| **Description** | Un cocktail rafraîchissant pour transformer du code fatigué en module propre, lisible et maintenable. |
| **UseCase** | Refactoriser un composant .NET legacy pour le rendre plus testable, mieux structuré et conforme aux bonnes pratiques. |
| **Thème** | Productivité |
| **Sous-thème** | Analyse / optimisation de code |
| **Plateforme** | ChatGPT, Claude |
